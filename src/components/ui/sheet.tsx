...
export const SheetHeader = ({
  ...
  <div
    className={cn("flex flex-col gap-1 p-6 border-b sticky top-0 bg-background z-10", className)}
    {...props}
  />
);
...
export const SheetFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse gap-2 p-4 border-t sticky bottom-0 bg-background safe-pb sm:flex-row sm:justify-end",
      className,
    )}
    {...props}
  />
